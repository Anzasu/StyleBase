...
import 'overview_type_model.dart';
export 'overview_type_model.dart';

class OverviewTypeWidget extends StatefulWidget {
  const OverviewTypeWidget({super.key});

  static String routeName = 'Overview_Type';
  static String routePath = '/overviewType';

  @override
  State<OverviewTypeWidget> createState() => _OverviewTypeWidgetState();
}

class _OverviewTypeWidgetState extends State<OverviewTypeWidget> {
  late OverviewTypeModel _model;
  int count = 0;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OverviewTypeModel());
  }
  ...
  Widget getItemsListView() {
    debugPrint('Current filterType: $filterType');

    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 150.0),
      child: FutureBuilder<List<ClothingItem>>(
        future: _databaseService.getTypeItems(filterType),
