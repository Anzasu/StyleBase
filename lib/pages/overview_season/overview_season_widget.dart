...
import 'overview_season_model.dart';
export 'overview_season_model.dart';

class OverviewSeasonWidget extends StatefulWidget {
  const OverviewSeasonWidget({super.key});

  static String routeName = 'Overview_Season';
  static String routePath = '/overviewSeason';

  @override
  State<OverviewSeasonWidget> createState() => _OverviewSeasonWidgetState();
}
...
class _OverviewSeasonWidgetState extends State<OverviewSeasonWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OverviewSeasonModel());
  }
